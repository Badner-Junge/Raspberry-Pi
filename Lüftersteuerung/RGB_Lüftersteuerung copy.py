...
while 1:                        # Schleife zur dauernden Abfrage starten
    ...
    print("CPU hat " + temperature + " °C (" + str(sec) + ")")     # Ausgabe Temperatur
    ...
    if fantime2 == -1:                          # wenn Lüfter 2 aus
        if temperature < warm:
            ...
            if fantime != -1:                   # Wenn Lüfter 1 an
                fan.one()                       # Lüfter 1 an
                fantime -= 1                    # Lüfter 1 Intervallanzehl -1
            else:
                fan.off()                       # Lüfter aus
                fantime = -1                    # Lüfter 1 Laufzeit Startwert
        ...
        fantime -= 1                            # Lüfter 1 Intervallanzahl -1
        fantime2 -= 1                           # Lüfter 2 Intervallanzahl -1
        if temperature < warm:
            LED.green()
        elif temperature >= warm and temperature < hot:
            LED.yellow()
    ...
    if fantime2 != -1:                          # wenn Lüfter 2 Zähler nicht -1
        print("Fan 1", fantime * sec, "Sek." + "(" + str(sec) + ")")   # Ausgabe Lüfter 1 Zähler
        print("Fan 2", fantime2 * sec, "Sek." + "(" + str(sec) + ")")  # Ausgabe Lüfter 2 Zähler
